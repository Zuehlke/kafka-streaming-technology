...
💡 When creating a table, you have different properties to influence the behaviour of this table. Have a look at https://docs.ksqldb.io/en/0.8.1-ksqldb/developer-guide/ksqldb-reference/create-table/

We will now use the mapping of the timestamp from your payload to the KSQL-Table:
